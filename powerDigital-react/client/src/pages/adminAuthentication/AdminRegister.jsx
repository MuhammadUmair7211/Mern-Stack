...
const AdminRegister = () => {
	...
	const handleSubmit = async (e) => {
		e.preventDefault();
		try {
			const res = await fetch("http://localhost:3000/api/adminAuth/register", {
				method: "POST",
				headers: {
	...
	return (
		<div className="min-h-screen flex items-center justify-center">
			<div className="max-w-lg w-full flex flex-col items-center mx-auto p-8 shadow-[0_0_5px_0]">
				...
				<form className="me-auto w-full" onSubmit={handleSubmit}>
					<div>
						<label htmlFor="username" className="block text-md mt-4">
							Username
						</label>
						<input
							type="text"
					...
					<p className="text-center text-sm mt-4">
						...
						<Link
							to="/admin-login"
							className="text-blue-500 font-bold hover:text-blue-800 duration-300"
						>
							Login here
						</Link>
					</p>
